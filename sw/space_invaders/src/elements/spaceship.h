...
#define SPACESHIP_WIDTH				(BITMAP_SPACESHIP_WIDTH*SPACESHIP_SCALE)
#define SPACESHIP_HEIGHT			(BITMAP_SPACESHIP_HEIGHT*SPACESHIP_SCALE)
#define SPACESHIP_ORIGIN_Y			MISSILE_TOP_BUFFER

// positions
#define SPACESHIP_START_LEFT_X		(USHRT_MAX-SPACESHIP_WIDTH)
#define SPACESHIP_START_RIGHT_X		SCREEN_WIDTH
#define SPACESHIP_SHIFT_X			1
#define SPACESHIP_SHIFT_Y			0

// scoring
#define SPACESHIP_SCORE_COLOR		SCREEN_COLOR_RED
